        ...
        <List spacing={3}>
          {products.map((product) => (
            <ListItem key={product.id} p={5} shadow="md" borderWidth="1px" borderRadius="md" bg={formBackground}>
              <Flex align="center">
                <Box flexShrink={0}>
                  <Image borderRadius="md" boxSize="100px" src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxwcm9kdWN0fGVufDB8fHx8MTcxMjU0Mjc0MXww&ixlib=rb-4.0.3&q=80&w=1080" alt={product.name} mr={4} />
                </Box>
                <Box flex="1">
